import numpy as np
from Axial_Magnetic_Field.Order_Parameter import magnetic_order_parameters_localgen_honeycomb
...
# This code presumes calculated and saved raw data (from Honeycomb_SCHF_AFM_With_Axial_Field.py in this directory)
...
gen_local_afm_order, gen_local_fm_order = magnetic_order_parameters_localgen_honeycomb(raw_data_path, num_generations)
